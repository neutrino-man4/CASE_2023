        ...
        if do_qr:
            ...
            for quantile in quantiles:
                ...
                if train_qr:
                    ...
                    lambda_discriminator = qrwf.train_L4QR(quantile, mixed_train_sample, mixed_valid_sample, params)
            ...
            plot_name = 'lambdaV4_iter_%s_multi_discr_cut_'%iteration+params.sig_sample_id.replace('Reco','')+'_x'+str(int(xsec))
