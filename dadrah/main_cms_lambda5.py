...
params = Parameters(run_n=50000, 
                    ...
                    qcd_test_sample_id='qcdSigMCOrigReco',
        ...
        if do_qr:
            ...
            for quantile in quantiles:
                ...
                if train_qr:
                    ...
                    lambda_discriminator = qrwf.train_L5QR(quantile, mixed_train_sample, mixed_valid_sample, params)
            ...
            for q, model_path in zip(quantiles, model_paths):
                discriminator = disc.L5QRDiscriminator_KerasAPI(quantile=q, loss_strategy=lost.loss_strategy_dict[params.strategy_id])
            ...
            plot_name = 'lambdaV5_iter_%s_multi_discr_cut_'%iteration+params.sig_sample_id.replace('Reco','')+'_x'+str(int(xsec))
