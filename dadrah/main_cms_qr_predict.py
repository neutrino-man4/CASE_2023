...
#params = Parameters(run_n=336, sample_id='qcdSigBisReco', quantile=0.1, strategy=lost.loss_strategy_dict['s5'])
params = Parameters(run_n=336, sample_id='qcdSigReco', quantile=0.1, strategy=lost.loss_strategy_dict['s5'])
