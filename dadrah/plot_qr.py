...
for i in [10,30,50,70,90,99]:
    files = glob.glob('/data/t3home000/bmaier/CASE/QR_results/analysis/run_50000/sig_WkkToWRadionToWWW_M3000_Mr170Reco/xsec_0/loss_rk5_05/qr_cuts/qrdnn_*x0Q*%s.0.txt'%(str(i)))
...
plt.savefig("/home/tier3/bmaier/public_html/figs/case/kvae/run_50000/qr/plots_aggregate/qrdnn_aggregate.pdf", bbox_inches='tight')
plt.savefig("/home/tier3/bmaier/public_html/figs/case/kvae/run_50000/qr/plots_aggregate/qrdnn_aggregate.png", bbox_inches='tight', dpi=300)
