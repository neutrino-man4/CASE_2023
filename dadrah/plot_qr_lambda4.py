...
for i in [10,30,50,70,90,99]:
    files = glob.glob('/data/t3home000/bmaier/CASE/QR_results/analysis/run_50000/sig_WkkToWRadionToWWW_M3000_Mr170Reco/xsec_0/loss_rk5_05/qr_cuts/lambdaV4_*x0Q*%s*.txt'%(str(i)))
...
plt.savefig("/home/tier3/bmaier/public_html/figs/case/kvae/run_50000/qr/plots_aggregate/qr_aggregate_lambdaV4.pdf", bbox_inches='tight')
plt.savefig("/home/tier3/bmaier/public_html/figs/case/kvae/run_50000/qr/plots_aggregate/qr_aggregate_lambdaV4.png", bbox_inches='tight', dpi=300)
